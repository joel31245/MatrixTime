...
int main(){
    ...
    for ( currentSize=50; currentSize<N; currentSize+=50 ){
        ...
        if(currentSize == N-50) fprintf(ijk, "%d", elapsed); else fprintf(ijk, "%d,",elapsed);
        // JIK
        QueryPerformanceCounter(&start);
        for (j=0; j<currentSize; j++) {
            for (i=0; i<currentSize; i++) {
        ...
        elapsed = (int) (finish.QuadPart - start.QuadPart);
        printf("N(%d): %d\t",currentSize,elapsed);
        if(currentSize == N-50) fprintf(jik, "%d", elapsed); else fprintf(jik, "%d,",elapsed);
        ...
        elapsed = (int) (finish.QuadPart - start.QuadPart);
        printf("N(%d): %d\t",currentSize,elapsed);
        if(currentSize == N-50) fprintf(kij, "%d", elapsed); else fprintf(kij, "%d,",elapsed);
        // IKJ
        QueryPerformanceCounter(&start);
        for (i=0; i<currentSize; i++) {
            for (k=0; k<currentSize; k++) {
        ...
        elapsed = (int) (finish.QuadPart - start.QuadPart);
        printf("N(%d): %d\t",currentSize,elapsed);
        if(currentSize == N-50) fprintf(ikj, "%d", elapsed); else fprintf(ikj, "%d,",elapsed);
        ...
        elapsed = (int) (finish.QuadPart - start.QuadPart);
        printf("N(%d): %d\t",currentSize,elapsed);
        if(currentSize == N-50) fprintf(jki, "%d", elapsed); else fprintf(jki, "%d,",elapsed);
        // KJI
        QueryPerformanceCounter(&start);
        for (k=0; k<currentSize; k++) {
            for (j=0; j<currentSize; j++) {
        ...
        elapsed = (int) (finish.QuadPart - start.QuadPart);
        printf("N(%d): %d\n",currentSize,elapsed);
        if(currentSize == N-50) fprintf(kji, "%d", elapsed); else fprintf(kji, "%d,",elapsed);
